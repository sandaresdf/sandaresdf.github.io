...
<head>
  ...
  <title>Sandares Dhanujaya - Portfolio</title>
  <!-- ===== CSS Files ===== -->
        ...
        <div class="container">
          <div class="row">
            <div class="home-info padd-15">
              <h3 class="hello">Hello, my name is <span class="name">Sandares Dhanujaya</span></h3>
              <h3 class="my-profession">I' m a <span class="typing"></span></h3>
              <p>I'm a AI Developer with extensive experience for over 3 years. My expertise is to create AI enabled
                chatbots using RASA, Natural Language Processing (NLP), and Large Language Models (LLM), and many
                more...</p>
              <a href="Sandares_Dhanujaya.pdf" class="btn">Download CV</a>
            </div>
            ...
            <div class="about-content padd-15">
              <div class="row">
                <div class="about-text padd-15">
                  <h3>I'm Sandares Dhanujaya and <span>AI Developer</span></h3>
                  <p>I'm currently working as an AI developer for Yenasys (Pvt) Ltd and also an undergraduate from the
                    University of Colombo School of Computing Sri Lanka in Computer Science. I have +3 years of
                    experience and I’m highly passionate about research and development. I prefer to work with team
                    spirit, in an innovative and creative environment, and change positively to keep pace with the
                    globe. As a well-performing AI developer, I aim to find new creative solutions for current problems
                    using AI.</p>
                </div>
              </div>
              <div class="row">
                <div class="personal-info padd-15">
                  <div class="row">
                    <div class="info-item padd-15">
                      <p>Birthday : <span>10 Sep 2001</span></p>
                    </div>
                    <div class="info-item padd-15">
                      <p>Age : <span>23</span></p>
                    </div>
                    <div class="info-item padd-15">
                      <p>Website : <span>www.zenimra.com</span></p>
                    </div>
                    <div class="info-item padd-15">
                      <p>Email : <span>sandaresdf3070@gmail.com</span></p>
                    </div>
                    <div class="info-item padd-15">
                      <p>Degree : <span>Computer Science</span></p>
                    </div>
                    <div class="info-item padd-15">
                      <p>Phone : <span>+94 71 307 0420</span></p>
                    </div>
                    <div class="info-item padd-15">
                      <p>City : <span>Minuwangoda, Gampaha</span></p>
                    </div>
                    <div class="info-item padd-15">
                    ...
                    <div class="timeline-box padd-15">
                      <div class="timeline shadow-dark">
                        ...
                        <div class="timeline-item">
                          ...
                          <h4 class="timeline-title">BSc. (hons) in Computer Science</h4>
                          <p class="timeline-text">Unversity of Colombo School of Computing</p>
                        </div>
                        <!-- ===== timeline item ===== -->
                        <div class="timeline-item">
                          <div class="circle-dot"></div>
                          ...
                          <h4 class="timeline-title">Diploma in Information Technology</h4>
                          <p class="timeline-text">Unversity of Colombo School of Computing</p>
                        </div>
                        <!-- ===== timeline item ===== -->
                        <!-- <div class="timeline-item">
                    ...
                    <div class="timeline-box padd-15">
                      <div class="timeline shadow-dark">
                        ...
                        <div class="timeline-item">
                          ...
                          <h4 class="timeline-title">AI Developer (Part-time)</h4>
                          <p class="timeline-text">Yenasys (Pvt) Ltd</p>
                        </div>
                        <!-- ===== timeline item ===== -->
                        <div class="timeline-item">
                          <div class="circle-dot"></div>
                          ...
                          <h4 class="timeline-title">AI Developer (Internship)</h4>
                          <p class="timeline-text">Yenasys (Pvt) Ltd</p>
                        </div>
          ...
          <div class="row">
            ...
            <div class="service-item padd-15">
              <div class="service-item-inner">
                ...
                <p>Leverage the power of artificial intelligence to transform your business operations. I specialize in
                  creating intelligent systems that automate processes, enhance decision-making, and deliver actionable
                  insights tailored to your specific needs.</p>
              </div>
            </div>
            <!-- ===== Service item End ====== -->
            <!-- ===== Service item Start ====== -->
            <div class="service-item padd-15">
              <div class="service-item-inner">
                ...
                <p>Build a strong online presence with a professionally crafted website. I offer end-to-end web
                  development services, from responsive design to seamless functionality, ensuring your website stands
                  out and drives engagement.</p>
              </div>
            </div>
            <!-- ===== Service item End ====== -->
            <!-- ===== Service item Start ====== -->
            <div class="service-item padd-15">
              <div class="service-item-inner">
                ...
                <p>Bring your ideas to life with custom mobile applications. I develop user-friendly and scalable mobile
                  apps that deliver exceptional performance across devices, providing your users with a seamless and
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="contact-info-item padd-15">
              ...
              <h4>LinkedIn</h4>
              <p>www.linkedin.com/in/sandares-dhanujaya-b051a7216</p>
            </div>
            <!-- ===== Contact info item end ====== -->
          </div>
